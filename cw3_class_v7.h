...
public:
  ...
  // Task 2
  float task2Move(std::vector<geometry_msgs::PointStamped> ref_object_points, 
  ...
  int colorFilter(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_in, const Eigen::Vector4f centroid);
                  //  pcl::PointXYZRGB rgb_color_red, pcl::PointXYZRGB rgb_color_blue, 
                  //  pcl::PointXYZRGB rgb_color_purple); 
  ...
  void Task3_calOrientation(const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& cloud, const pcl::PointCloud<pcl::PointXYZRGB>::Ptr& cloud_out); 

  bool task3Move(geometry_msgs::PointStamped pick_point, geometry_msgs::PointStamped goal_point, std::string shape_type, geometry_msgs::Quaternion grasp_orientation);
  
  bool Task3_pickObj(geometry_msgs::PointStamped pick_point, geometry_msgs::Quaternion grasp_orientation);
  ...
  //float arm_height = 0.78; 
  float arm_height = 0.756; 
  ...
  std::vector<geometry_msgs::Pose> shape_objects = {};
